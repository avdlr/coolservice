    	...
    	var modaldialog = $("#dialog").dialog({
 	        ...
 	        [ 
 	        	{ id:"aceptarform","data-test":"data test", 
 	        		text: "Aceptar", 
                                click:    function() {
                                        var skipValid = ( $("#formtecnico").is(':hidden') && $("#frmtipomantenimiento").val() === "PREVENTIVO" );
                                        var bandvalida = true;
                                        var parmarca = $("#marca").val();
                                        if(!skipValid && parmarca==""){$("#sec-marca").addClass("has-error"); bandvalida=false;}else{$("#sec-marca").removeClass("has-error");}
...
//  	        			if(parmodelo==""){$("#sec-modelo").addClass("has-error"); bandvalida=false;}else{$("#sec-modelo").removeClass("has-error");}
                                        ...
                                        if(!skipValid && parvoltaje==""){$("#sec-parvoltaje").addClass("has-error"); bandvalida=false;}else{$("#sec-parvoltaje").removeClass("has-error");}
                                        var paramperes = $("#amperes").val();
                                        if(!skipValid && paramperes==""){$("#sec-amperes").addClass("has-error"); bandvalida=false;}else{$("#sec-amperes").removeClass("has-error");}
//  	        			var parrazonserv = $("#razonserv").val();  
                                        var parservreal = $("#servreal option:selected").text();
                                        if(parservreal=="Seleccionar...") parservreal="";
                                        if(!skipValid && parservreal==""){$("#sec-servreal").addClass("has-error"); bandvalida=false;}else{$("#sec-servreal").removeClass("has-error");}
                                        var bandservreal = "";
                                        if(parservreal=="OTRO")
                                        {
                                                bandservreal ="S";
                                                parservreal=$("#otroServicioReal").val();
                                                if(!skipValid && parservreal==""){$("#sec-otroServicioReal").addClass("has-error"); bandvalida=false;}else{$("#sec-otroServicioReal").removeClass("has-error");}
                                        }
                                        var parcomentarios = $("#comentarios").val();
                                        if(!skipValid && parcomentarios==""){$("#sec-comentarios").addClass("has-error"); bandvalida=false;}else{$("#sec-comentarios").removeClass("has-error");}
                                        var parcon1 = $("#cond1").val();
                                        if(!skipValid && parcon1==""){$("#sec-cond1").addClass("has-error"); bandvalida=false;}else{$("#sec-cond1").removeClass("has-error");}
                                                var parcon2 = $("#cond2").val();
                                                if(!skipValid && parcon2==""){$("#sec-cond2").addClass("has-error"); bandvalida=false;}else{$("#sec-cond2").removeClass("has-error");}
                                                var partempopera = $("#tempopera").val();
                                                if(!skipValid && partempopera==""){$("#sec-tempopera").addClass("has-error"); bandvalida=false;}else{$("#sec-tempopera").removeClass("has-error");}
                                                var parvoltaje2 = $("#voltaje2").val();
                                                if(!skipValid && parvoltaje2==""){$("#sec-voltaje2").addClass("has-error"); bandvalida=false;}else{$("#sec-voltaje2").removeClass("has-error");}
                                                var paramperes2 = $("#amperes2").val();
                                                if(!skipValid && paramperes2==""){$("#sec-amperes2").addClass("has-error"); bandvalida=false;}else{$("#sec-amperes2").removeClass("has-error");}
...
// 	 	   				if(partenicoserv==""){$("#sec-tenicoserv").addClass("has-error"); bandvalida=false;}else{$("#sec-tenicoserv").removeClass("has-error");}
                                                ...
                                                if(parnombreequipo=="Seleccionar...") parnombreequipo="";
                                                if(!skipValid && parnombreequipo==""){$("#sec-nombreequipo").addClass("has-error"); bandvalida=false;}else{$("#sec-nombreequipo").removeClass("has-error");}
                                                var bandEquipo ="";
                                                if(parnombreequipo=="OTRO")
                                                {
                                                bandEquipo= "S";
                                                parnombreequipo =$("#otroNombreEquipo").val();
                                                if(!skipValid && parnombreequipo==""){$("#sec-otroNombreEquipo").addClass("has-error"); bandvalida=false;}else{$("#sec-otroNombreEquipo").removeClass("has-error");}
                                                }
                                                var parservterminado = $('input[name=servterminado]:checked').val();
                                                var partempounidad = $('input[name=tempounidad]:checked').val();
                                                if(skipValid){partempounidad="";$("#sec-otroNombreEquipo").removeClass("has-error");}
                                                else if(partempounidad==undefined){$("#sec-otroNombreEquipo").addClass("has-error"); bandvalida=false;}else{$("#sec-otroNombreEquipo").removeClass("has-error");}
