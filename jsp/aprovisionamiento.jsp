	    		...
	    		<div class="col-xs-12">
    			 ...
    			 <thead>
		            <tr>
						...
						<tr>
       			 			<td style="background-color: #f4f7ff;font-weight: bold;"><%= obj.getString("descripcion")%></td>
       			 			<td style="text-align: center"><%= obj.getString("tiempo")%> minutos</td>
