...
<body>
	<div class="col-xs-12">
		...
		<div class="col-xs-8"><input disabled type="text" id="frmtipomant" style="width:100%;" class="form-control"  placeholder="" value="<%=registro.getString("tipoorden")%>"/></div>
</div>
	<div class="col-xs-12" style="margin-top: 5px;">
		<div class="col-xs-4">Estatus:</div>
		<div class="col-xs-8"><input disabled type="text" id="frmestatus" style="width:100%;" class="form-control"  placeholder="" value="<%=registro.getString("ESTATUS")%>"/></div>
	</div>
	<div class="col-xs-12" style="margin-top: 5px;">
		<div class="col-xs-4" style="margin-top: 5px;">T&eacute;cnico Asignado:</div>
		<div class="col-xs-8" style="margin-top: 5px;"><input disabled type="text" id="frmtecnicoasig" style="width:100%;" class="form-control"  placeholder="" value="<%=registro.getString("tecnico")%>"/></div>
	</div>
...
<%-- 				<input disabled type="text" id="frmdireccion" style="width:100%;" class="form-control"  placeholder="" value="<%=registro.getString("domicilio")%>"/> --%>
				</div>
			...
			<div class="row">
				...
				<div class="col-xs-8"><input disabled type="text" id="frmciudad" style="width:100%;" class="form-control"  placeholder="" value="<%=registro.getString("ciudad")%>"/></div>
			...
			<div class="row">
				...
				<div class="col-xs-8"><input disabled type="text" id="frmestado" style="width:100%;" class="form-control"  placeholder="" value="<%=registro.getString("estado")%>"/></div>
			</div>
			</div>
...
<%-- 				<div class="col-xs-8"><input  disabled type="text" id="frmgerente" style="width:100%;" class="form-control"  placeholder="" value="<%=registro.getString("gerente")%>"/></div> --%>
...
<!-- 			</div> -->
			...
			<div class="row">
				...
				<div class="col-xs-8"><input disabled  type="text" id="frmhorareg" style="width:100%;" class="form-control"  placeholder="" value="<%=registro.getString("hora")%>"/></div>
			</div>
			</div>
...
<!-- 	  ********************************************************************fechas tab********************************************************************************************* -->
	  <div class="tab-pane fade" id="fechas" role="tabpanel" aria-labelledby="fechas-tab" onclick="ocultarDetalle(this.id+'seg')">
		...
		<div class="col-xs-12" style="padding-top: 5px;">
			<div class="row">
				<div class="col-xs-4">Fecha/Hora Registro:</div>
				<div class="col-xs-8">
			...
			<div class="col-xs-12" style="padding-top: 5px;">
			<div class="row">
			<div class="col-xs-4">Fecha/Hora Reporte:</div>
				<div class="col-xs-8"><input disabled type="text" id="frmfecharep" style="width:100%;" class="form-control"  placeholder="" value="<%=registro.getString("fecha")%> <%=registro.getString("hora")%>"/></div>
			...
			<div class="col-xs-12" style="padding-top: 5px;">
			<div class="row">
				<div class="col-xs-4">Fecha/Hora Cita:</div>
				<div class="col-xs-8"><input disabled type="text" id="frmfechacita" style="width:100%;" class="form-control"  placeholder="" value="<%=registro.getString("FECHACITA")%> <%=registro.getString("HORACITA")%>"/></div>
			...
			<div class="col-xs-12" style="padding-top: 5px;">
			<div class="row">
			<div class="col-xs-4">Fecha/Hora Entrada:</div>
				<div class="col-xs-8">
			...
			<div class="col-xs-12" style="padding-top: 5px;">
			<div class="row">
				<div class="col-xs-4">Fecha/Hora Salida:</div>
				<div class="col-xs-8">
	  ...
	  <div class="tab-pane fade" id="equipo" role="tabpanel" aria-labelledby="equipo-tab">
		...
		<div class="col-xs-12" style="padding-top: 5px;">
			...
			<div class="row">
				...
				<div class="col-xs-8"><input disabled type="text" id="frmmodelo" style="width:100%;" class="form-control"  placeholder="" value="<%=registro.getString("MODELO")%>"/></div>
			</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-xs-8"><input disabled type="text" id="frmserie" style="width:100%;" class="form-control"  placeholder="" value="<%=registro.getString("SERIE")%>"/></div>
			...
			<div class="row">
				...
				<div class="col-xs-8"><input disabled type="text" id="frmvoltaje" style="width:100%;" class="form-control"  placeholder="" value="<%=registro.getString("VOLTAJE")%>"/></div>
			...
			<div class="row">
				...
				<div class="col-xs-8"><input  disabled type="text" id="frmAmperes" style="width:100%;" class="form-control"  placeholder="" value="<%=registro.getString("AMPERES")%>"/></div>
...
<!-- 	  *******************************************************************servicio tab****************************************************** -->
	  <div class="tab-pane fade" id="servicio" role="tabpanel" aria-labelledby="servicio-tab">
		...
		<div class="col-xs-12" style="padding-top: 5px;">
			...
			<div class="col-xs-4">Servicio Realizado:</div>
				<div class="col-xs-8"><input disabled type="text" id="frmservreal" style="width:100%;" class="form-control"  placeholder="" value="<%=registro.getString("SERVREAL")%>"/></div>
			</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-xs-8"><input disabled type="text" id="frmcomentarios" style="width:100%;" class="form-control"  placeholder="" value="<%=registro.getString("COMENTARIOS")%>"/></div>
			</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-xs-4">Temp. Operaci&oacute;n:</div>
				<div class="col-xs-8">
	...
	<div class="tab-pane fade" id="movimientos" role="tabpanel" aria-labelledby="movimientos-tab">
        ...
        <thead>
            <tr>
		  		<th style="min-width: 150px;">Acci&oacute;n</th>
                <th style="min-width: 150px;">Estatus Anterior</th>
                <th style="min-width: 150px;">Estatus Siguiente</th>
                <th style="min-width: 150px;">T&eacute;cnico Anterior</th>
                <th style="min-width: 150px;">T&eacute;cnico Siguiente</th>
                <th style="min-width: 150px;">Motivo</th>
				<th style="min-width: 150px;">Usuario Registro</th>
