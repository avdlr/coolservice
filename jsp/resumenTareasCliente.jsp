...
<%
	...
	JSONArray lista = llamado.consultaTareasCliente(tipousuario, "1,2,3,6", tecnico, orden, cliente, sucursal, fechaini, fechafin,zona,Integer.parseInt(pagina),"todas");
...
// 			alert(parametros);
			...
			$("#divisionTareas").load('<%=request.getContextPath()%>'+'/jsp/resumenTareasCliente.jsp?'+parametros);
		}
